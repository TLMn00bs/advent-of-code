...
data=$(jq '.members | flatten | sort_by(.stars) | reverse | .[] | {name: .name, stars: .stars}' leaderboard2023.json | sed 's/Rubén Maté/rubenmate/' | sed 's/Jesús Arellano/jesusarell/' | sed 's/0rb3/i97orbegozo/')
...
data=$(jq '.members | flatten | sort_by(.stars) | reverse | .[] | {name: .name, stars: .stars}' leaderboard2022.json | sed 's/Rubén Maté/rubenmate/'  | sed 's/Jesús Arellano/jesusarell/' | sed 's/0rb3/i97orbegozo/')
...
data=$(jq '.members | flatten | sort_by(.stars) | reverse | .[] | {name: .name, stars: .stars}' leaderboard2021.json | sed 's/Rubén Maté/rubenmate/'  | sed 's/Jesús Arellano/jesusarell/' | sed 's/0rb3/i97orbegozo/')
...
data=$(jq '.members | flatten | sort_by(.stars) | reverse | .[] | {name: .name, stars: .stars}' leaderboard2020.json | sed 's/Rubén Maté/rubenmate/'  | sed 's/Jesús Arellano/jesusarell/' | sed 's/0rb3/i97orbegozo/')
